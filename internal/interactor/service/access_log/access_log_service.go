...
import (
	store "app.inherited.magic/internal/entity/access_log"
	db "app.inherited.magic/internal/entity/db/access_logs"
	model "app.inherited.magic/internal/interactor/models/access_logs"
